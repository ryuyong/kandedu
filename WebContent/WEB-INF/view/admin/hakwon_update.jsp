...
<br/>
<p class="bg-primary bg-titleval">과목수정</p>
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<th>과목폴더명</th>
						<td>
							<input type="text" id="kwamok_folder_cd" name="kwamok_folder_cd" class="form-control" placeholder="과목명입력" value="${result.kwamok_nm}" />
						</td>
					</tr>
				</tbody>
			</table>
